...
val_check = [2, 50, 75, 100, 125, 150, 175, 200, 225, 250, 260, 270, 275, 280, 285, 290, 295, 300]
...
def main(args):
    ...
    args.checkpoint = '/workspace/IMFuse/IM-Fuse/m3ae/runs/m3ae_pretrain/model_1model_best_599.pth.tar'
